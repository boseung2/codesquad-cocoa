...
public class IndianNaming {
    ...
    static void printWord(String[] wordArray, int calendarNum, int count){
        for(int i = 0; i < count; i++){
            if(calendarNum % count == i)
    ...
    static void printMonth(int month){
        ...
        printWord(monthWord, month - 1, 12);
